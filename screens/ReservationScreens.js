...
const ReservationScreen = () => {
		...
		Alert.alert(
			...
			[
				...
				},
				{
					text: "OK",
					onPress: () => {
						presentLocalNotification(date.toLocaleTimeString("en-us"));
						resetForm();
					},
				},
			],
	...
	const presentLocalNotification = async (reservationDate) => {
		...
		let permissions = await Notifications.getPresentedNotificationsAsync();
			...
			<Animatable.View animation="zoomIn" delay={1000} duration={2000}>
				...
				<View styles={styles.formRow}>
					<Button
						...
						color="#5637DD"
						accessibilityLabel="Tap me to search for availability campsites to reserve"
					/>
				</View>
			</Animatable.View>
		</ScrollView>
